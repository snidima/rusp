   ...
   // print_r(form_error());
    ...
    <form method="post" id="signupForm">
        ...
        <div class="mtop10 form-group">
            <input type="text" name="nickname" placeholder="Название рассылки" class="form-control" maxlength="20" title="Запрещено использование email, оскорблений, мата и спама." required>
        </div>
        <div class="mtop10 form-group">
            <textarea name="maillistDesc" placeholder="Описание рассылки" class="form-control" title="Запрещено использование email, оскорблений, мата и спама."></textarea>
        </div>
        <div class="mtop10 form-group">
                ...
                nickname: {
                    ...
                    validators: {
                        ...
                        remote: {
                            ...
                            type: 'POST',
                            message: "Имя уже занято либо содержит запрещенные символы или слова"
                        }
                    }
                },
                ...
                maillistDesc: {
                   threshold: 3,
                    validators: {
                        ...
                        remote: {
                            url: '/user/checkMailListDesc/',
                            type: 'POST',
                            message: "Описание одержит запрещенные символы или слова"
                        }
                    }
                },
                pwd2: {
